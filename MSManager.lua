...
function MSM:CreateFrame()
    ...
    local listLabel = RLSuite.utils:CreateFontString(self.listBox, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local addLabel = RLSuite.utils:CreateFontString(self.addBox, nil, "OVERLAY", "GameFontNormalSmall")
