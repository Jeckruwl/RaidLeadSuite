...
function GM:CreateMainWindow()
    ...
    local raidLabel = RLSuite.utils:CreateFontString(f, nil, "OVERLAY", "GameFontNormal")
    ...
    local diffLabel = RLSuite.utils:CreateFontString(f, nil, "OVERLAY", "GameFontNormal")
    ...
    local compLabel = RLSuite.utils:CreateFontString(self.compBox, nil, "OVERLAY", "GameFontNormal")
    ...
    local classBarLabel = RLSuite.utils:CreateFontString(self.classBox, nil, "OVERLAY", "GameFontNormal")
    ...
    local reservedLabel = RLSuite.utils:CreateFontString(self.reqBox, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local otherLabel = RLSuite.utils:CreateFontString(self.reqBox, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    self.previewText = RLSuite.utils:CreateFontString(self.previewBox, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local specsLbl = RLSuite.utils:CreateFontString(f, nil, "OVERLAY", "GameFontNormalSmall")
...
function GM:BuildCompSlots()
    ...
    self.groupLabels = {}
    for g = 1, 5 do
        local fs = RLSuite.utils:CreateFontString(self.compFrame, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    for i = 1, maxSlots do
        ...
        slot.roleText = RLSuite.utils:CreateFontString(slot, nil, "OVERLAY", "GameFontNormalSmall")
        slot.roleText:SetPoint("BOTTOM", slot, "BOTTOM", 0, 2)
        RLSuite.utils:ApplyFont(slot.roleText, "tiny", "OUTLINE")
...
function GM:BuildClassBar()
    ...
    for _, class in ipairs(classes) do
        ...
        local nameFS = RLSuite.utils:CreateFontString(cell, nil, "OVERLAY", "GameFontNormalSmall")
...
function GM:CreateWhisplistWindow()
    ...
    local compLabel = RLSuite.utils:CreateFontString(self.wlCompBox, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local listLabel = RLSuite.utils:CreateFontString(self.wlListBox, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    self.wlDetailName = RLSuite.utils:CreateFontString(self.wlDetailBox, nil, "OVERLAY", "GameFontNormal")
    ...
    self.wlDetailInfo = RLSuite.utils:CreateFontString(self.wlDetailBox, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    self.wlChatText = RLSuite.utils:CreateFontString(self.wlChat, nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local customLabel = RLSuite.utils:CreateFontString(self.wlDetailBox, nil, "OVERLAY", "GameFontNormalSmall")
...
function GM:UpdateWhisplist()
    ...
    for i, entry in ipairs(entries) do
        ...
        local text = RLSuite.utils:CreateFontString(row, nil, "OVERLAY", "GameFontNormalSmall")
